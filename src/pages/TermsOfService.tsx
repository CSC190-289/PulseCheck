        ...
        <Card>
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
                You agree to use PulseCheck for academic purposes only and refrain from cheating or disrupting the platform.
              </Typography>
        ...
        <Card>
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
                You are responsible for maintaining the confidentiality of your account information. <br></br>
              </Typography>
        ...
        <Card>
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
                All content within PulseCheck is owned by the company or licensed to us, and users may not reproduce or distribute it without permission. <br></br>
              </Typography>
        ...
        <Card>
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
                PulseCheck is not responsible for any errors in quiz results or issues caused by third-party services. <br></br>
              </Typography>
