...
<RA.Bounce triggerOnce>
            ...
            <RA.Bounce triggerOnce>
              <Typography fontWeight={700} mb={2}>
                At PulseCheck, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data.
              </Typography>
            </RA.Bounce>
          ...
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
                We collect personal information such as names, email addresses, and quiz results.
              </Typography>
        ...
        <Card>
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
              Your data is used to provide personalized results, track quiz participation, and improve the app’s functionality.
              </Typography>
        ...
        <Card>
          <CardContent>
            <RA.Bounce triggerOnce>
              ...
              <Typography display={"inline"} mb={2}>
              You have the right to request access to, or deletion of, your personal information at any time.
              </Typography>
